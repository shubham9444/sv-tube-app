    ...
    return <Container maxW={'container.xl'} h={'100vh'} p={'16'}>
        <form >
            <VStack alignItems={'stretch'} spacing={'8'} w={['full', '96']} m={'auto'} my={'16'}>
                <Heading textAlign={'center'}>Shubham Video Tube</Heading>
                ...
                <Text textAlign={'right'}>Already Signd Up?{' '}
                    <Button colorScheme={'purple'} variant={'link'}><Link to={'/login'}>Log In</Link></Button>
                </Text>
            </VStack>
        </form>
